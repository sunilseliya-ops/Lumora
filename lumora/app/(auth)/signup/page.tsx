...
export default function SignupPage() {
  ...
  return (
    ...
    >
      <div className="blob-violet" style={{ width: 500, height: 500, top: -150, left: -100 }} />
      <div className="blob-gold" style={{ width: 400, height: 400, bottom: -100, right: -50 }} />
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ color: '#8892A4', fontSize: 13, marginTop: 8 }}>Start your journey</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#8892A4' }}>
          ...
          <Link href="/login" style={{ color: '#E8A020', textDecoration: 'none' }}>
            Sign in
          </Link>
        </p>
      </div>
